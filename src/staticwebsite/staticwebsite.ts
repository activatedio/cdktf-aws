...
class StaticWebsite extends Construct {
  ...
  constructor(scope: Construct, id: string, props: StaticWebsiteProps) {
    ...
    const identity = new aws.cloudfrontOriginAccessIdentity.CloudfrontOriginAccessIdentity(this, "identity", {})
    ...
    const restrictions: aws.cloudfrontDistribution.CloudfrontDistributionRestrictions = props.restrictions ? props.restrictions : {
      geoRestriction: {
    ...
    const viewerCertificate: aws.cloudfrontDistribution.CloudfrontDistributionViewerCertificate = props.viewerCertificate ? props.viewerCertificate : {
